  ...
  return (
    <header className=''>
      ...
      >
        ...
        >
          {/* desktop nav */}
          <div className='relative flex flex-grow items-center justify-center border-neutral-6  lg:col-span-2'>
            <a href='/'>
          ...
          >
            <nav
              className={`z-20 flex h-fit min-h-[90vh] translate-x-[0] flex-col bg-neutral-9 px-8 pb-64 pt-4 duration-md ease-in-out dark:bg-neutral-9`}
            >
              {navs.map((nav) => (
