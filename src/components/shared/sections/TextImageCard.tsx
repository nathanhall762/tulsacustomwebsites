...
const TextImagecard: React.FC<Props> = ({
  ...
  return (
    <section className={`${reversed && 'lg:ml-32'} ${!reversed && 'lg:mr-32'} my-16 lg:my-32 flex justify-center`}>
      <div className='flex  flex-col transition-all lg:grid lg:grid-cols-12 lg:gap-8'>
        <img
          src={image}
          alt={image_alt_text}
          className={`${reversed && 'lg:order-1'}  box-border w-screen object-cover lg:col-span-5 lg:row-span-1 lg:w-full lg:h-full`}
        />
